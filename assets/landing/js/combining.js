...
!function (e, t) {
	...
	!function () {
		...
		function o(o, s) {
			if (this.el = o, this.$el = e(o), this.s = e.extend({}, t, s), this.s.dynamic && "undefined" !== this.s.dynamicEl && this.s.dynamicEl.constructor === Array && !this.s.dynamicEl.length) throw"When using dynamic mode, you must also define dynamicEl as an Array.";
		...
		o.prototype.init = function () {
			...
			return s ? {youtube: s} : i ? {vimeo: i} : l ? {dailymotion: l} : r ? {vk: r} : void 0
		}, o.prototype.counter = function () {
			this.s.counter && e(this.s.appendCounterTo).append('<div id="lg-counter"><span id="lg-counter-current">' + (parseInt(this.index, 10) + 1) + '</span> / <span id="lg-counter-all">' + this.$items.length + "</span></div>")
		}, o.prototype.addHtml = function (t) {
			var o, s, i = null;
			if (this.s.dynamic ? this.s.dynamicEl[t].subHtmlUrl ? o = this.s.dynamicEl[t].subHtmlUrl : i = this.s.dynamicEl[t].subHtml : (s = this.$items.eq(t)).attr("data-sub-html-url") ? o = s.attr("data-sub-html-url") : (i = s.attr("data-sub-html"), this.s.getCaptionFromTitleOrAlt && !i && (i = s.attr("title") || s.find("img").first().attr("alt"))), !o) if (null != i) {
			...
			if (!c.$slide.eq(t).hasClass("lg-loaded")) {
				if (g) c.$slide.eq(t).prepend('<div class="lg-video-cont lg-has-iframe" style="max-width:' + c.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + l + '"  allowfullscreen="true"></iframe></div></div>'); else if (u) {
					var p = "";
		...
		}, o.prototype.slide = function (t, o, s, i) {
			var l = this.$outer.find(".lg-current").index(), r = this;
			if (!r.lGalleryOn || l !== t) {
				var a = this.$slide.length, n = r.lGalleryOn ? this.s.speed : 0;
				if (!r.lgBusy) {
					var d, c, u;
			...
			var t = this, o = 0, s = 0, i = !1, l = !1;
			t.s.enableDrag && t.doCss() && (t.$slide.on("mousedown.lg", function (s) {
				t.$outer.hasClass("lg-zoomed") || t.lgBusy || e(s.target).text().trim() || (s.preventDefault(), t.manageSwipeClass(), o = s.pageX, i = !0, t.$outer.scrollLeft += 1, t.$outer.scrollLeft -= 1, t.$outer.removeClass("lg-grab").addClass("lg-grabbing"), t.$el.trigger("onDragstart.lg"))
	...
	!function () {
		...
		s.prototype.init = function () {
			...
			o() && this.exitFullscreen(), e(document).off("fullscreenchange.lg webkitfullscreenchange.lg mozfullscreenchange.lg MSFullscreenChange.lg")
	...
	!function () {
		...
		o.prototype.init = function () {
			var t, o, s, i = this, l = "";
			if (i.core.$outer.find(".lg").append('<div class="lg-pager-outer"></div>'), i.core.s.dynamic) for (var r = 0; r < i.core.s.dynamicEl.length; r++) l += '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' + i.core.s.dynamicEl[r].thumb + '" /></div></span>'; else i.core.$items.each(function () {
			...
			(o = i.core.$outer.find(".lg-pager-outer")).html(l), (t = i.core.$outer.find(".lg-pager-cont")).on("click.lg touchend.lg", function () {
				var t = e(this);
	...
	!function () {
		...
		o.prototype.init = function () {
			...
			if (o.core.$outer.addClass("lg-has-thumb"), o.core.$outer.find(".lg").append('<div class="lg-thumb-outer"><div class="lg-thumb lg-group"></div></div>'), o.$thumbOuter = o.core.$outer.find(".lg-thumb-outer"), o.thumbOuterWidth = o.$thumbOuter.width(), o.core.s.animateThumb && o.core.$outer.find(".lg-thumb").css({
				...
				position: "relative"
			}), this.core.s.animateThumb && o.$thumbOuter.css("height", o.core.s.thumbContHeight + "px"), o.core.s.dynamic) for (var r = 0; r < o.core.s.dynamicEl.length; r++) l(o.core.s.dynamicEl[r].src, o.core.s.dynamicEl[r].thumb, r); else o.core.$items.each(function (t) {
			...
			o.core.$outer.find(".lg-thumb").html(s), (t = o.core.$outer.find(".lg-thumb-item")).each(function () {
				var t = e(this), s = t.attr("data-vimeo-id");
				s && e.getJSON("//www.vimeo.com/api/v2/video/" + s + ".json?callback=?", {format: "json"}, function (e) {
			...
			var t = this, o = 0, s = 0, i = !1, l = !1, r = 0;
	...
	!function () {
		...
		o.prototype.init = function () {
			var t = this;
			t.core.$el.on("hasVideo.lg.tm", function (e, t, o, s) {
				var i = this;
				if (i.core.$slide.eq(t).find(".lg-video").append(i.loadVideo(o, "lg-object", !0, t, s)), s) if (i.core.s.videojs) try {
			...
			}), t.core.$el.on("onBeforeSlide.lg.tm", function (t, o, s) {
				var i, l = this.core.$slide.eq(o), r = l.find(".lg-youtube").get(0), a = l.find(".lg-vimeo").get(0),
					n = l.find(".lg-dailymotion").get(0), d = l.find(".lg-vk").get(0), c = l.find(".lg-html5").get(0);
				if (r) r.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"); else if (a) try {
					$f(a).api("pause")
				} catch (e) {
					console.error("Make sure you have included froogaloop2 js")
				} else if (n) n.contentWindow.postMessage("pause", "*"); else if (c) if (this.core.s.videojs) try {
					videojs(c).pause()
				} catch (e) {
					console.error("Make sure you have included videojs")
				} else c.pause();
			...
			var r = "", a = 1, n = "", d = this.core.isVideo(t, i) || {};
			if (s && (a = this.videoLoaded ? 0 : this.core.s.autoplayFirstVideo ? 1 : 0), d.youtube) n = "?wmode=opaque&autoplay=" + a + "&enablejsapi=1", this.core.s.youtubePlayerParams && (n = n + "&" + e.param(this.core.s.youtubePlayerParams)), r = '<iframe class="lg-video-object lg-youtube ' + o + '" width="560" height="315" src="//www.youtube.com/embed/' + d.youtube[1] + n + '" frameborder="0" allowfullscreen></iframe>'; else if (d.vimeo) n = "?autoplay=" + a + "&api=1", this.core.s.vimeoPlayerParams && (n = n + "&" + e.param(this.core.s.vimeoPlayerParams)), r = '<iframe class="lg-video-object lg-vimeo ' + o + '" width="560" height="315"  src="//player.vimeo.com/video/' + d.vimeo[1] + n + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>'; else if (d.dailymotion) n = "?wmode=opaque&autoplay=" + a + "&api=postMessage", this.core.s.dailymotionPlayerParams && (n = n + "&" + e.param(this.core.s.dailymotionPlayerParams)), r = '<iframe class="lg-video-object lg-dailymotion ' + o + '" width="560" height="315" src="//www.dailymotion.com/embed/video/' + d.dailymotion[1] + n + '" frameborder="0" allowfullscreen></iframe>'; else if (d.html5) {
				var c = l.substring(0, 1);
				"." !== c && "#" !== c || (l = e(l).html()), r = l
			} else d.vk && (n = "&autoplay=" + a, this.core.s.vkPlayerParams && (n = n + "&" + e.param(this.core.s.vkPlayerParams)), r = '<iframe class="lg-video-object lg-vk ' + o + '" width="560" height="315" src="//vk.com/video_ext.php?' + d.vk[1] + n + '" frameborder="0" allowfullscreen></iframe>');
			return r
		}, o.prototype.loadVideoOnclick = function (e) {
			var t = this;
			if (e.find(".lg-object").hasClass("lg-has-poster") && e.find(".lg-object").is(":visible")) if (e.hasClass("lg-has-video")) {
				var o = e.find(".lg-youtube").get(0), s = e.find(".lg-vimeo").get(0),
					i = e.find(".lg-dailymotion").get(0), l = e.find(".lg-html5").get(0);
				if (o) o.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}', "*"); else if (s) try {
					$f(s).api("play")
				} catch (e) {
					console.error("Make sure you have included froogaloop2 js")
				} else if (i) i.contentWindow.postMessage("play", "*"); else if (l) if (t.core.s.videojs) try {
					videojs(l).play()
				} catch (e) {
					console.error("Make sure you have included videojs")
				} else l.play();
				...
				var r = function (o, s) {
					if (e.find(".lg-video").append(t.loadVideo(o, "", !1, t.core.index, s)), s) if (t.core.s.videojs) try {
	...
	!function () {
		...
		var t, o, s = {
			...
			return this.core = e(t).data("lightGallery"), this.core.s = e.extend({}, s, this.core.s), this.core.s.zoom && this.core.doCss() && (this.init(), this.zoomabletimeout = !1, this.pageX = e(window).width() / 2, this.pageY = e(window).height() / 2 + e(window).scrollTop()), this
		};
		i.prototype.init = function () {
			...
			var s = 1, i = function (o) {
				var s = t.core.$outer.find(".lg-current .lg-image"),
					...
					r = (o - 1) * (t.pageX - i), a = (o - 1) * (t.pageY - l);
			...
			var t = this, o = {}, s = {}, i = !1, l = !1, r = !1, a = !1;
			...
			var i = this.core.$slide.eq(this.core.index).find(".lg-img-wrap"),
				...
				r = -Math.abs(i.attr("data-x")) + (t.x - e.x), a = -Math.abs(i.attr("data-y")) + (t.y - e.y),
				...
				u = Math.abs(l.prop("offsetWidth") * Math.abs(l.attr("data-scale")) - this.core.$outer.find(".lg").width() + c);
			(Math.abs(t.x - e.x) > 15 || Math.abs(t.y - e.y) > 15) && (s && (a <= -d ? a = -d : a >= -n && (a = -n)), o && (r <= -u ? r = -u : r >= -c && (r = -c)), s ? i.attr("data-y", Math.abs(a)) : a = -Math.abs(i.attr("data-y")), o ? i.attr("data-x", Math.abs(r)) : r = -Math.abs(i.attr("data-x")), this.core.s.useLeftForZoom ? i.css({
				left: r + "px",
				top: a + "px"
	...
	!function () {
		...
		o.prototype.init = function () {
			...
			o += t.core.s.facebook ? '<li><a id="lg-share-facebook" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.facebookDropdownText + "</span></a></li>" : "", o += t.core.s.twitter ? '<li><a id="lg-share-twitter" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.twitterDropdownText + "</span></a></li>" : "", o += t.core.s.googlePlus ? '<li><a id="lg-share-googleplus" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.googlePlusDropdownText + "</span></a></li>" : "", o += t.core.s.pinterest ? '<li><a id="lg-share-pinterest" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.pinterestDropdownText + "</span></a></li>" : "", o += "</ul></span>", this.core.$outer.find(".lg-toolbar").append(o), this.core.$outer.find(".lg").append('<div id="lg-dropdown-overlay"></div>'), e("#lg-share").on("click.lg", function () {
				...
				setTimeout(function () {
					e("#lg-share-facebook").attr("href", "https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent(t.getSahreProps(i, "facebookShareUrl") || window.location.href)), e("#lg-share-twitter").attr("href", "https://twitter.com/intent/tweet?text=" + t.getSahreProps(i, "tweetText") + "&url=" + encodeURIComponent(t.getSahreProps(i, "twitterShareUrl") || window.location.href)), e("#lg-share-googleplus").attr("href", "https://plus.google.com/share?url=" + encodeURIComponent(t.getSahreProps(i, "googleplusShareUrl") || window.location.href)), e("#lg-share-pinterest").attr("href", "http://www.pinterest.com/pin/create/button/?url=" + encodeURIComponent(t.getSahreProps(i, "pinterestShareUrl") || window.location.href) + "&media=" + encodeURIComponent(t.getSahreProps(i, "src")) + "&description=" + t.getSahreProps(i, "pinterestText"))
				}, 100)
			})
		}, o.prototype.getSahreProps = function (e, t) {
			var o = "";
			if (this.core.s.dynamic) o = this.core.s.dynamicEl[e][t]; else {
				var s = this.core.$items.eq(e).attr("href"), i = this.core.$items.eq(e).data(t);
				o = "src" === t && s || i
			}
			return o
		}, o.prototype.destroy = function () {
...
var Constructzilla = function () {
	var e = $(window).width(), t = function (e) {
		if (0 == jQuery(e).length) return !1;
		var t, r = 0, i = 0, a = new Array;
		$(e).each(function () {
			if (t = $(this), $(t).height("auto"), topPostion = t.position().top, i != topPostion) {
				for (currentDiv = 0; currentDiv < a.length; currentDiv++) a[currentDiv].height(r);
				a.length = 0, i = topPostion, r = t.height(), a.push(t)
			} else a.push(t), r = r < t.height() ? t.height() : r;
			for (currentDiv = 0; currentDiv < a.length; currentDiv++) a[currentDiv].height(r)
		})
	}, r = function () {
		"use strict";
	...
	return {
		init: function () {
			...
			jQuery(".box-hover").on("mouseenter", function () {
				...
				$(".scroll").unbind().on("click", function (e) {
					if (e.preventDefault(), "" !== this.hash) {
						var t = this.hash, r = $(t).offset().top, i = parseInt($(".onepage").css("height"), 10);
				...
				if (jQuery(".dzload").each(function () {
					...
					jQuery(".mo-left .header-nav").prepend(t), jQuery(".mo-left .header-nav .logo-header > a > img").attr("src", "images/logo.png"), jQuery(".mo-left.lw .header-nav .logo-header > a > img").attr("src", "images/logo-white.png"), jQuery(".mo-left .header-nav .logo-header.dark > a > img").attr("src", "images/logo-black.png")
				}
			...
			}(a), e > 768 && $(".content-scroll").length > 0 && $(".content-scroll").mCustomScrollbar({
				setWidth: !1,
				setHeight: !1,
				axis: "y"
				...
				jQuery(".modal:visible").each(i), t(".equal-wraper .equal-col"), r()
			...
			}), t(".equal-wraper .equal-col"), t(".equal-wraper2 .equal-col"), t(".equal-wraper3 .equal-col"), t(".equal-wraper4 .equal-col"), jQuery(".counter").length && jQuery(".counter").counterUp({
				delay: 10,
				time: 3e3
			}), function () {
				"use strict";
...
jQuery(document).ready(function () {
	Constructzilla.init(), jQuery(window).width() <= 991 && jQuery(".navbar-nav > li > a, .sub-menu > li > a").on("click", function (e) {
	...
	Constructzilla.load(), setTimeout(function () {
...
jQuery(document).ready(function () {
	jQuery(".img-carousel").owlCarousel({
		...
		dots: !1,
		navText: ['<i class="fa fa-chevron-left"></i>', '<i class="fa fa-chevron-right"></i>'],
		responsive: {0: {items: 1}, 480: {items: 2}, 1024: {items: 3}, 1400: {items: 4}}
		...
		dots: !1,
		navText: ['<i class="fa fa-chevron-left"></i>', '<i class="fa fa-chevron-right"></i>'],
		responsive: {0: {items: 2, center: !0, margin: 15}, 480: {items: 2}, 767: {items: 3}, 1000: {items: 5}}
...
jQuery(window).on("load", function () {
	...
	addSwitcher(), jQuery(".switch-btn").on("click", function () {
		...
		return jQuery(".skin").attr("href", "css/skin/skin-1.css"), jQuery(".logo-header img").attr("src", "images/logo.png"), jQuery(".logo-header.dark img").attr("src", "images/logo-black.png"), jQuery(".logo-footer img").attr("src", "images/logo-dark.png"), jQuery(".sidenav .logo-header img").attr("src", "images/logo-black.png"), jQuery(".full-blog-dark .sidenav .logo-header img").attr("src", "images/logo1.png"), !1
	}), jQuery(".skin-2").on("click", function () {
		return jQuery(".skin").attr("href", "css/skin/skin-2.css"), jQuery(".logo-header img").attr("src", "images/logo2.png"), jQuery(".logo-header.dark img").attr("src", "images/logo-black-2.png"), jQuery(".logo-footer img").attr("src", "images/logo-dark2.png"), jQuery(".sidenav .logo-header img").attr("src", "images/logo-black-2.png"), jQuery(".full-blog-dark .sidenav .logo-header img").attr("src", "images/logo2.png"), !1
	}), jQuery(".skin-3").on("click", function () {
		return jQuery(".skin").attr("href", "css/skin/skin-3.css"), jQuery(".logo-header img").attr("src", "images/logo3.png"), jQuery(".logo-header.dark img").attr("src", "images/logo-black-3.png"), jQuery(".logo-footer img").attr("src", "images/logo-dark3.png"), jQuery(".sidenav .logo-header img").attr("src", "images/logo-black-3.png"), jQuery(".full-blog-dark .sidenav .logo-header img").attr("src", "images/logo3.png"), !1
	}), jQuery(".skin-4").on("click", function () {
		return jQuery(".skin").attr("href", "css/skin/skin-4.css"), jQuery(".logo-header img").attr("src", "images/logo4.png"), jQuery(".logo-header.dark img").attr("src", "images/logo-black-4.png"), jQuery(".logo-footer img").attr("src", "images/logo-dark4.png"), jQuery(".sidenav .logo-header img").attr("src", "images/logo-black-4.png"), jQuery(".full-blog-dark .sidenav .logo-header img").attr("src", "images/logo4.png"), !1
	}), jQuery(".skin-5").on("click", function () {
		return jQuery(".skin").attr("href", "css/skin/skin-5.css"), jQuery(".logo-header img").attr("src", "images/logo5.png"), jQuery(".logo-header.dark img").attr("src", "images/logo-black-5.png"), jQuery(".logo-footer img").attr("src", "images/logo-dark5.png"), jQuery(".sidenav .logo-header img").attr("src", "images/logo-black-5.png"), jQuery(".full-blog-dark .sidenav .logo-header img").attr("src", "images/logo5.png"), !1
	}), jQuery(".skin-6").on("click", function () {
		return jQuery(".skin").attr("href", "css/skin/skin-6.css"), jQuery(".logo-header img").attr("src", "images/logo6.png"), jQuery(".logo-header.dark img").attr("src", "images/logo-black-6.png"), jQuery(".logo-footer img").attr("src", "images/logo-dark6.png"), jQuery(".sidenav .logo-header img").attr("src", "images/logo-black-6.png"), jQuery(".full-blog-dark .sidenav .logo-header img").attr("src", "images/logo6.png"), !1
	}), jQuery(".skin-7").on("click", function () {
		return jQuery(".skin").attr("href", "css/skin/skin-7.css"), jQuery(".logo-header img").attr("src", "images/logo7.png"), jQuery(".logo-header.dark img").attr("src", "images/logo-black-7.png"), jQuery(".logo-footer img").attr("src", "images/logo-dark7.png"), jQuery(".sidenav .logo-header img").attr("src", "images/logo-black-7.png"), jQuery(".full-blog-dark .sidenav .logo-header img").attr("src", "images/logo7.png"), !1
	}), jQuery(".skin-8").on("click", function () {
		return jQuery(".skin").attr("href", "css/skin/skin-8.css"), jQuery(".logo-header img").attr("src", "images/logo8.png"), jQuery(".logo-header.dark img").attr("src", "images/logo-black-8.png"), jQuery(".logo-footer img").attr("src", "images/logo-dark8.png"), jQuery(".sidenav .logo-header img").attr("src", "images/logo-black-8.png"), jQuery(".full-blog-dark .sidenav .logo-header img").attr("src", "images/logo8.png"), !1
